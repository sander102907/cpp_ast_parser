...
class Tester:
    ...
    def test_programs(self, input_folder, compile_folder, test_results_path):
        ...
        try:
            for _ in range(max_task):
                t = threading.Thread(target=self.program_tester,
    ...
    def program_tester(self, file_queue, pbar, solutions, problems, compile_folder, return_data):
        while True:
...
if __name__ == '__main__':
    ...
    test_results_path = 'test_results6.csv'

    tester = Tester()

    tester.test_programs(input_folder, compile_folder, test_results_path)
